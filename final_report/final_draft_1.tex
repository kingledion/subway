...
\def\siglinewithspace{\rule{2.8 in}{0.4 pt}}
...
\null\vskip .1in
\begin{center}
\underline{REGRESSION MODELS FOR PREDICTING RAIL TRANSIT RIDERSHIP AT THE STATION LEVEL}\\[0.2 in]
by \\ [0.2 in]
Daniel Hartig \\
A Thesis \\
Submitted to the\\
...
\end{center}
Committee:\\[16 pt]
\siglinewithspace\hspace{0.1in} Dr. Martin Slawski, Thesis Director \\[0.2 in]
\siglinewithspace\hspace{0.1in} Dr. Clifton Sutton, Committee Member        \\[0.2 in]
\siglinewithspace\hspace{0.1in} Dr. Larry Tang, Committee Member       \\[0.2 in]
%        \siglinewithspace \@thirdmember        \\[\intercommspace]
\siglinewithspace\hspace{0.1in} Dr. William Rosenberger, Chairman, Department\\
\phantom{\siglinewithspace\!\!}\hspace{0.15in} of Statistics \\[0.2 in]
\siglinewithspace\hspace{0.1in} Dr. Kenneth S. Ball, Dean, Volgenau School \\
\phantom{\siglinewithspace\!\!}\hspace{0.15in}   of Engineering \\[0.2 in]
Date: \rule{5.96 cm}{0.4 pt} \hspace{0.5 cm} \!\!Spring 2019\\
 \phantom{Date: \rule{5.96 cm}{0.4 pt} \hspace{0.5 cm} \!\!}George Mason University \\
\phantom{Date: \rule{5.96 cm}{0.4 pt} \hspace{0.5 cm} \!\!}Fairfax, VA
\newpage
...
\null\vskip .5825in 
\begin{center}
Regression Models for Predicting Rail Transit Ridership at the Station Level\\[10 pt]
\end{center}
A thesis submitted in partial fulfillment of the requirements for
the degree of \\ Master of Science at George Mason University \\[10 pt]%[35 pt]
\begin{center}
By \\[35 pt]
Daniel Hartig \\
Bachelor of Science\\
United States Naval Academy , 2008\\[39 pt]
Director: Martin Slawski, Assistant Professor \\
Department of Statistics \\[35 pt]
Fall 2018 \\
George Mason University \\
Fairfax, VA
\end{center}
...
\setcounter{page}{2}
\begin{center}
Copyright\ \copyright\ 2018 by Daniel Hartig\\
All Rights Reserved
\end{center}
\vfill\newpage
...
\end{center}
REGRESSION MODELS FOR PREDICTION RAIL TRANSIT RIDERSHIP AT THE STATION LEVEL\\
Daniel Hartig, MS \\
George Mason University, 2019 \\
Thesis Director: Dr. Martin Slawski \\[0.5 in]
...
\section{Data distribution and regression selection}
...
%\appchapter[An Appendix]{Ridership data}\label{app:ridership}
\begingroup
