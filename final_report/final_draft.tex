...
\begin{figure}[H]
\centering
\subfloat[Example of positive linear relationship]{\includegraphics[clip,width=0.5\columnwidth]{exRegPosSlope}}
\subfloat[Example of negative linear relationship]{\includegraphics[clip,width=0.5\columnwidth]{exRegNegSlope}}
...
\State{$randomPoints \gets$ random latitude and longitude coordinates selected from with the shapefile of $zipcode$}
